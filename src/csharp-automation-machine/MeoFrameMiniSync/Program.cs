// -------------------------------------------------------
// File:    Program.cs
// Project: MeoFrameMiniSync — bản KHÔNG dùng Task của chương trình mẫu
...
public sealed class SimulatedAxis : IAxis
{
    ...
    public SimulatedAxis(string name, StopFlag stop, double speedMmPerStep = 40.0)
    {
...
public sealed class StepMoveTo : IStep
{
    ...
    public StepMoveTo(IAxis axis, double targetMm, string name, StopFlag stop)
    {
...
public sealed class MachineController
{
    ...
    public MachineController(IAxis axis, PressureMonitor pressure,
...
public static class Program
{
    public static void Main()
    {
        ...
        IAxis           axisX   = new SimulatedAxis("X", stop, speedMmPerStep: 40.0);
        ...
        Console.WriteLine("=== MeoFrameMiniSync — bản không dùng Task ===");
